                ...
                <form action="{{ route('admin.categories.store') }}" method="POST" role="form" enctype="multipart/form-data">
                    ...
                    <div class="tile-body">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control @error('name2') is-invalid @enderror" type="text" name="name2" id="name2" value="{{ old('name2') }}"/>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" rows="4" name="description2" id="description2">{{ old('description2') }}</textarea>
                        </div>
                        <div class="form-group">
