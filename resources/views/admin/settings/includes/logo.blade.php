            ...
            <div class="row">
				...
				<div class="col-3">
                    @if (config('settings.home_pre') != null)
                        <img src="{{ asset('storage/'.config('settings.home_pre')) }}" id="homepre" style="width: 80px; height: auto;">
                    @else
                        <img src="https://via.placeholder.com/80x80?text=Placeholder+Image" id="homepre" style="width: 80px; height: auto;">
                    @endif
                </div>
                <div class="col-9">
                    <div class="form-group">
                        <label class="control-label">Pre Home Image</label>
                        <input class="form-control" type="file" name="home_pre" onchange="loadFile(event,'homepre')"/>
                    </div>
                </div>
            </div>
            <div class="row mt-4">
