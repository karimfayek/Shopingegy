                        ...
                        <form action="{{ route('admin.products.update') }}" method="POST" role="form">
                            ...
                            <div class="tile-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="control-label" for="sale_price">Old Price</label>
                                            <input
                                                class="form-control"
                                                type="text"
                                ...
                                <div class="form-group" id="editor">
                                    ...
                                    <textarea name="description2" id="description2" rows="8" class="form-control">{{ old('description2', $product->description2) }}</textarea>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="row">
                                    @foreach($product->images as $image)
                                        <div class="col-md-3">
                                            <div class="card">
                                                <div class="card-body">
                                                    <img src="{{ asset('storage/products/mobile_photos/'.$image->full) }}" id="brandLogo" class="img-fluid" alt="img">
