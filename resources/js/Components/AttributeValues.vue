            ...
            <div class="tile-body">
                ...
                <div class="form-group" id="color">
                    ...
                    <input
                        class="form-control"
                        type="color"
                        placeholder="if you adding color"
                        
                        name="color"
                        v-model="color"
						style=" width: 57px;height: 40px; padding: 2px;"
                    />
                </div>
                 <div class="form-group">
                    <label class="control-label" for="value">Value Arabic</label>
                    <input
                        class="form-control"
                        type="text"
                        placeholder="Enter attribute value"
                ...
                <div class="table-responsive">
                    <table class="table table-sm">
                        ...
                        <tr v-for="value in values" :key="value.id">
                            ...
                            <td style="width: 25%" class="text-center">{{ value.valuear}}</td>
