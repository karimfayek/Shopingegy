...
Vue.component('minicart', require('./components/MiniCart').default);
Vue.component('category', require('./components/Category').default);
Vue.component('cart', require('./components/Cart').default);
Vue.component('homeproducts', require('./components/HomeProducts').default);
Vue.component('productgallery', require('./components/ProductGallery').default);
/**
